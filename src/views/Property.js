          ...
          {property.householdMembers.map((tenant) => {
            return (
              <tr className="govuk-table__row" key={tenant.id}>
                ...
                <td className="govuk-table__cell">{tenant.personTenureType}</td>
                <td className="govuk-table__cell">
                  <Link
...
const Property = () => {
  ...
  return (
    <>
      <PropertyView status={status} property={property} />
