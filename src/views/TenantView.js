...
const Tenant = () => {
  ...
  const tenantViewOut = () => {
    ...
    return (
      <>
        <h1>
          {TextReferences.Titles.Tenant}: {tenant.preferredTitle}{" "}
          {tenant.preferredFirstName} {tenant.preferredSurname}
        </h1>
        ...
        {tenant.charges && (
          <>
            ...
            {descriptionList([
              {
                key: "Current Balance",
                val: CurrencyFormat(tenant.charges.currentBalance),
              },
              {
                key: "Weekly Total Charges",
                val: CurrencyFormat(tenant.charges.rent),
              },
              {
                key: "Service Charge",
                val: CurrencyFormat(tenant.charges.serviceCharge),
              },
        ...
        {descriptionList([
          ...
          { key: "Tenure Type", val: tenant.personTypes.join(", ") },
          {
            ...
            val: DateFormat(tenant.startOfTenureDate),
          },
