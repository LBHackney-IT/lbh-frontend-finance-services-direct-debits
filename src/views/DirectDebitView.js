  ...
  const DDView = () => {
    ...
    return <>
      ...
      {descriptionList([
        ...
        { key: 'Cancellation Date', val: DateFormat(result.cancellationDate) },
        { key: 'First Payment Date', val: DateFormat(result.firstPaymentDate) },
      ...
      {descriptionList([
        ...
        { key: 'Additional Amount', val: CurrencyFormat(result.additionalAmount) },
      ...
      {descriptionList([
        ...
        { key: 'Bank Address', val: `${result.bankOrBuildingSocietyAddress1} ${result.bankOrBuildingSocietyAddress2} ${result.bankOrBuildingSocietyAddress3} ${result.bankOrBuildingSocietyPostcode}`
        },
      ])}
